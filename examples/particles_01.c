...
"   {\n"
"       particle.velocity = normalize(vec4(-particle.position.xyz, 0.0f));\n"
"       particle.velocity *= vec4(noise_at_pos * 0.5f + vec3(0.5f), 1.0f);\n"
"       if(noise_at_pos.x > 0.6f)\n"
"       {\n"
...
"   particle.color = 2.0f *  vec4(color * (1.0f + pow(1.0f - lntgh / 7.0f, 4.0f)), 0.0f);\n"
"	particles[index] = particle;\n"
"}\n"
"\n"
"void main()\n"
